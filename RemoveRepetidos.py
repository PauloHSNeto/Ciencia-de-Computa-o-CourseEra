...
def calcula_assinatura(texto):
    ...
    ass_a[1]=float(n_palavras_diferentes(lista_palavras)/len(lista_palavras))
    ass_a[2]=float(n_palavras_unicas(lista_palavras)/len(lista_palavras))
